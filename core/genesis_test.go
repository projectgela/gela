...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.GelaMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.GelaMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.GelaMainnetGenesisHash,
			wantConfig: params.GelaMainnetChainConfig,
		},
		{
