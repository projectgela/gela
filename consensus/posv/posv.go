...
type TradingService interface {
	...
	ApplyOrder(coinbase common.Address, chain consensus.ChainContext, statedb *state.StateDB, gelXstatedb *tradingstate.TradingStateDB, orderBook common.Hash, order *tradingstate.OrderItem) ([]map[string]string, []*tradingstate.OrderItem, error)
...
type Posv struct {
	...
	GetGelXService            func() TradingService
...
func (c *Posv) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (int, int, int, bool, error) {
	...
	if common.IsTestnet {
		// Only three mns hard code for gela testnet.
