...
import (
	...
	swarmmetrics "github.com/projectgela/gela/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//gela only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gela and swarm
