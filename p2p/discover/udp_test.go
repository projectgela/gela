...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingGela, &ping{From: testRemote, To: testLocalAnnounced, Version: Version})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingGela, &ping{From: testRemote, To: testLocalAnnounced, Version: Version, Expiration: futureExp})
