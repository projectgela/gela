...
//		- isSpecialCollateral			: TRUE if collateral is a token which is NOT available for trading in GelX, otherwise FALSE
...
// @param statedb : current state
// @return: list of terms which gelxlending supports
