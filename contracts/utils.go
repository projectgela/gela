...
import (
	...
	randomizeContract "github.com/projectgela/gela/contracts/randomize/contract"
	"github.com/projectgela/gela/core"
	"github.com/projectgela/gela/core/state"
	stateDatabase "github.com/projectgela/gela/core/state"
...
func GetRandomizeFromContract(client bind.ContractBackend, addrMasternode common.Address) (int64, error) {
	randomize, err := randomizeContract.NewGelaRandomize(common.HexToAddress(common.RandomizeSMC), client)
	if err != nil {
