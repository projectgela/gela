...
/**
 * @title Standard GRC21 token
 * @dev Implementation of the basic standard token.
 */
contract GRC21 is IGRC21 {
...
contract MyGRC21 is GRC21 {
    ...
    constructor (address[] _owners,
                ...
                ) GRC21(_name, _symbol, _decimals) public validRequirement(_owners.length, _required) {
