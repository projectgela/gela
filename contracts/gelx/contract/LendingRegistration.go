...
// LAbstractGELXListingABI is the input ABI used to generate the binding from.
const LAbstractGELXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractGELXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractGELXListingBin = `0x`

// DeployLAbstractGELXListing deploys a new Ethereum contract, binding an instance of LAbstractGELXListing to it.
func DeployLAbstractGELXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractGELXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractGELXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractGELXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractGELXListing{LAbstractGELXListingCaller: LAbstractGELXListingCaller{contract: contract}, LAbstractGELXListingTransactor: LAbstractGELXListingTransactor{contract: contract}, LAbstractGELXListingFilterer: LAbstractGELXListingFilterer{contract: contract}}, nil
}

// LAbstractGELXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractGELXListing struct {
	LAbstractGELXListingCaller     // Read-only binding to the contract
	LAbstractGELXListingTransactor // Write-only binding to the contract
	LAbstractGELXListingFilterer   // Log filterer for contract events
}

// LAbstractGELXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractGELXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractGELXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractGELXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractGELXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractGELXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractGELXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractGELXListingSession struct {
	Contract     *LAbstractGELXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts         // Call options to use throughout this session
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// LAbstractGELXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractGELXListingCallerSession struct {
	Contract *LAbstractGELXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts               // Call options to use throughout this session
}

// LAbstractGELXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractGELXListingTransactorSession struct {
	Contract     *LAbstractGELXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// LAbstractGELXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractGELXListingRaw struct {
	Contract *LAbstractGELXListing // Generic contract binding to access the raw methods on
}

// LAbstractGELXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractGELXListingCallerRaw struct {
	Contract *LAbstractGELXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractGELXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractGELXListingTransactorRaw struct {
	Contract *LAbstractGELXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractGELXListing creates a new instance of LAbstractGELXListing, bound to a specific deployed contract.
func NewLAbstractGELXListing(address common.Address, backend bind.ContractBackend) (*LAbstractGELXListing, error) {
	contract, err := bindLAbstractGELXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractGELXListing{LAbstractGELXListingCaller: LAbstractGELXListingCaller{contract: contract}, LAbstractGELXListingTransactor: LAbstractGELXListingTransactor{contract: contract}, LAbstractGELXListingFilterer: LAbstractGELXListingFilterer{contract: contract}}, nil
}

// NewLAbstractGELXListingCaller creates a new read-only instance of LAbstractGELXListing, bound to a specific deployed contract.
func NewLAbstractGELXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractGELXListingCaller, error) {
	contract, err := bindLAbstractGELXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractGELXListingCaller{contract: contract}, nil
}

// NewLAbstractGELXListingTransactor creates a new write-only instance of LAbstractGELXListing, bound to a specific deployed contract.
func NewLAbstractGELXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractGELXListingTransactor, error) {
	contract, err := bindLAbstractGELXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractGELXListingTransactor{contract: contract}, nil
}

// NewLAbstractGELXListingFilterer creates a new log filterer instance of LAbstractGELXListing, bound to a specific deployed contract.
func NewLAbstractGELXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractGELXListingFilterer, error) {
	contract, err := bindLAbstractGELXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractGELXListingFilterer{contract: contract}, nil
}

// bindLAbstractGELXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractGELXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractGELXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractGELXListing *LAbstractGELXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractGELXListing.Contract.LAbstractGELXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractGELXListing *LAbstractGELXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractGELXListing.Contract.LAbstractGELXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractGELXListing *LAbstractGELXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractGELXListing.Contract.LAbstractGELXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractGELXListing *LAbstractGELXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractGELXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractGELXListing *LAbstractGELXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractGELXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractGELXListing *LAbstractGELXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractGELXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractGELXListing *LAbstractGELXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractGELXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractGELXListing *LAbstractGELXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractGELXListing.Contract.GetTokenStatus(&_LAbstractGELXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractGELXListing *LAbstractGELXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractGELXListing.Contract.GetTokenStatus(&_LAbstractGELXListing.CallOpts, arg0)
}

// LAbstractTokenGRC21ABI is the input ABI used to generate the binding from.
const LAbstractTokenGRC21ABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"issuer\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractTokenGRC21Bin is the compiled bytecode used for deploying new contracts.
const LAbstractTokenGRC21Bin = `0x`

// DeployLAbstractTokenGRC21 deploys a new Ethereum contract, binding an instance of LAbstractTokenGRC21 to it.
func DeployLAbstractTokenGRC21(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractTokenGRC21, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenGRC21ABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractTokenGRC21Bin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractTokenGRC21{LAbstractTokenGRC21Caller: LAbstractTokenGRC21Caller{contract: contract}, LAbstractTokenGRC21Transactor: LAbstractTokenGRC21Transactor{contract: contract}, LAbstractTokenGRC21Filterer: LAbstractTokenGRC21Filterer{contract: contract}}, nil
}

// LAbstractTokenGRC21 is an auto generated Go binding around an Ethereum contract.
type LAbstractTokenGRC21 struct {
	LAbstractTokenGRC21Caller     // Read-only binding to the contract
	LAbstractTokenGRC21Transactor // Write-only binding to the contract
	LAbstractTokenGRC21Filterer   // Log filterer for contract events
}

// LAbstractTokenGRC21Caller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractTokenGRC21Caller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenGRC21Transactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractTokenGRC21Transactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenGRC21Filterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractTokenGRC21Filterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenGRC21Session is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractTokenGRC21Session struct {
	Contract     *LAbstractTokenGRC21 // Generic contract binding to set the session for
	CallOpts     bind.CallOpts        // Call options to use throughout this session
	TransactOpts bind.TransactOpts    // Transaction auth options to use throughout this session
}

// LAbstractTokenGRC21CallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractTokenGRC21CallerSession struct {
	Contract *LAbstractTokenGRC21Caller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts              // Call options to use throughout this session
}

// LAbstractTokenGRC21TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractTokenGRC21TransactorSession struct {
	Contract     *LAbstractTokenGRC21Transactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts              // Transaction auth options to use throughout this session
}

// LAbstractTokenGRC21Raw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractTokenGRC21Raw struct {
	Contract *LAbstractTokenGRC21 // Generic contract binding to access the raw methods on
}

// LAbstractTokenGRC21CallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractTokenGRC21CallerRaw struct {
	Contract *LAbstractTokenGRC21Caller // Generic read-only contract binding to access the raw methods on
}

// LAbstractTokenGRC21TransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractTokenGRC21TransactorRaw struct {
	Contract *LAbstractTokenGRC21Transactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractTokenGRC21 creates a new instance of LAbstractTokenGRC21, bound to a specific deployed contract.
func NewLAbstractTokenGRC21(address common.Address, backend bind.ContractBackend) (*LAbstractTokenGRC21, error) {
	contract, err := bindLAbstractTokenGRC21(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenGRC21{LAbstractTokenGRC21Caller: LAbstractTokenGRC21Caller{contract: contract}, LAbstractTokenGRC21Transactor: LAbstractTokenGRC21Transactor{contract: contract}, LAbstractTokenGRC21Filterer: LAbstractTokenGRC21Filterer{contract: contract}}, nil
}

// NewLAbstractTokenGRC21Caller creates a new read-only instance of LAbstractTokenGRC21, bound to a specific deployed contract.
func NewLAbstractTokenGRC21Caller(address common.Address, caller bind.ContractCaller) (*LAbstractTokenGRC21Caller, error) {
	contract, err := bindLAbstractTokenGRC21(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenGRC21Caller{contract: contract}, nil
}

// NewLAbstractTokenGRC21Transactor creates a new write-only instance of LAbstractTokenGRC21, bound to a specific deployed contract.
func NewLAbstractTokenGRC21Transactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractTokenGRC21Transactor, error) {
	contract, err := bindLAbstractTokenGRC21(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenGRC21Transactor{contract: contract}, nil
}

// NewLAbstractTokenGRC21Filterer creates a new log filterer instance of LAbstractTokenGRC21, bound to a specific deployed contract.
func NewLAbstractTokenGRC21Filterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractTokenGRC21Filterer, error) {
	contract, err := bindLAbstractTokenGRC21(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenGRC21Filterer{contract: contract}, nil
}

// bindLAbstractTokenGRC21 binds a generic wrapper to an already deployed contract.
func bindLAbstractTokenGRC21(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenGRC21ABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21Raw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenGRC21.Contract.LAbstractTokenGRC21Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenGRC21.Contract.LAbstractTokenGRC21Transactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenGRC21.Contract.LAbstractTokenGRC21Transactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21CallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenGRC21.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenGRC21.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenGRC21.Contract.contract.Transact(opts, method, params...)
}

// Issuer is a free data retrieval call binding the contract method 0x1d143848.
//
// Solidity: function issuer() constant returns(address)
func (_LAbstractTokenGRC21 *LAbstractTokenGRC21Caller) Issuer(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _LAbstractTokenGRC21.contract.Call(opts, out, "issuer")
	return *ret0, err
}
...
// GelXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function GelXListing() constant returns(address)
func (_Lending *LendingCaller) GelXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "GelXListing")
	return *ret0, err
}
...
//
// Solidity: function GelXListing() constant returns(address)
func (_Lending *LendingSession) GelXListing() (common.Address, error) {
	return _Lending.Contract.GelXListing(&_Lending.CallOpts)
}

// GelXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function GelXListing() constant returns(address)
func (_Lending *LendingCallerSession) GelXListing() (common.Address, error) {
	return _Lending.Contract.GelXListing(&_Lending.CallOpts)
}
