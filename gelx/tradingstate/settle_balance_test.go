...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"BUY, quote is not GEL, makerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is not GEL, takerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is GEL, makerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseToken:         testToken,
				quoteToken:        common.HexToAddress(common.GelaNativeAddress),
				makerPrice:        common.BasePrice,
				makerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseTokenDecimal:  common.BasePrice,
				quoteTokenDecimal: common.BasePrice,
		...
		{
			"BUY, quote is GEL, takerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Taker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.GelaNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Maker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.GelaNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
		...
		{
			"SELL, quote is not GEL, makerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is not GEL, takerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is GEL, makerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is GEL, takerFee <= 0.001 GEL",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Maker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.GelaNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Taker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.GelaNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
	}
